...
export default function NoteDetails() {
  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col bg-zinc-50 items-center justify-center">
  ...
  if (error || !note) {
    return (
      <div className="h-screen flex flex-col bg-zinc-50 items-center justify-center space-y-4">
        <h1 className="text-2xl font-bold text-zinc-900">Note not found</h1>
        <p className="text-zinc-500">{error || "The note you are looking for does not exist."}</p>
        <button 
